      ...
      >
        ...
        >
          ...
          <View className="bg-white p-6 rounded-3xl shadow-md">
            ...
            {[
              { label: "Full Name", icon: "person-outline", placeholder: "John Doe" },
              { label: "Email Address", icon: "mail-outline", placeholder: "you@example.com" },
              { label: "Phone Number", icon: "call-outline", placeholder: "+1 (555) 123-4567" },
              { label: "Password", icon: "lock-closed-outline", placeholder: "Create a strong password", secure: true },
              { label: "Confirm Password", icon: "lock-closed-outline", placeholder: "Confirm your password", secure: true },
            ].map((field, index) => (
